...
//
     ...
     * @param document an empty {@link com.google.gwt.xml.client.Document} to use or null. If no document is specified, the
     * new {@link com.google.gwt.xml.client.Document} will be created using JAXP API.
     * @param options the "save" options
     ...
     * @return the {@link com.google.gwt.xml.client.Document}. In the case the document is specified as a parameter,
