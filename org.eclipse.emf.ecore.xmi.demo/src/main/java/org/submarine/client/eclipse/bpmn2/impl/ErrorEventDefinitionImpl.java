 ...
 * </p>
 * <ul>
 *   <li>{@link org.submarine.client.eclipse.bpmn2.impl.ErrorEventDefinitionImpl#getErrorRef <em>Error Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ErrorEventDefinitionImpl extends EventDefinitionImpl implements ErrorEventDefinition {
	 ...
	 */
	@GwtTransient
	protected org.submarine.client.eclipse.bpmn2.Error errorRef;
	 ...
	 * @generated
	 */
	public org.submarine.client.eclipse.bpmn2.Error getErrorRef() {
		if (errorRef != null && errorRef.eIsProxy()) {
			InternalEObject oldErrorRef = (InternalEObject) errorRef;
			errorRef = (org.submarine.client.eclipse.bpmn2.Error) eResolveProxy(oldErrorRef);
	 ...
	 * @generated
	 */
	public org.submarine.client.eclipse.bpmn2.Error basicGetErrorRef() {
		return errorRef;
	}
	 ...
	 * @generated
	 */
	public void setErrorRef(org.submarine.client.eclipse.bpmn2.Error newErrorRef) {
		org.submarine.client.eclipse.bpmn2.Error oldErrorRef = errorRef;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
		case Bpmn2Package.ERROR_EVENT_DEFINITION__ERROR_REF:
			setErrorRef((org.submarine.client.eclipse.bpmn2.Error) newValue);
			return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
		case Bpmn2Package.ERROR_EVENT_DEFINITION__ERROR_REF:
			setErrorRef((org.submarine.client.eclipse.bpmn2.Error) null);
			return;
		}
