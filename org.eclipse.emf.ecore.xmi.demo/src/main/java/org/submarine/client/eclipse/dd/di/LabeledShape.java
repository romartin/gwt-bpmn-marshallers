 ...
 * </p>
 * <ul>
 *   <li>{@link org.submarine.client.eclipse.dd.di.LabeledShape#getOwnedLabel <em>Owned Label</em>}</li>
 * </ul>
 *
 * @see org.submarine.client.eclipse.dd.di.DiPackage#getLabeledShape()
 * @model abstract="true"
...
public interface LabeledShape extends Shape {
	 ...
	 * @see org.submarine.client.eclipse.dd.di.DiPackage#getLabeledShape_OwnedLabel()
