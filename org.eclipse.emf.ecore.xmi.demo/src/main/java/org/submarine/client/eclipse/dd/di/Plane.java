 ...
 * </p>
 * <ul>
 *   <li>{@link org.submarine.client.eclipse.dd.di.Plane#getPlaneElement <em>Plane Element</em>}</li>
 * </ul>
 *
 * @see org.submarine.client.eclipse.dd.di.DiPackage#getPlane()
 * @model abstract="true"
...
public interface Plane extends Node {
	 ...
	 * @see org.submarine.client.eclipse.dd.di.DiPackage#getPlane_PlaneElement()
