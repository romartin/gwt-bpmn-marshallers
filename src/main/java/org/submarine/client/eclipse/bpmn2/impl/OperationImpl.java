 ...
 * </p>
 * <ul>
 *   <li>{@link org.submarine.client.eclipse.bpmn2.impl.OperationImpl#getInMessageRef <em>In Message Ref</em>}</li>
 *   <li>{@link org.submarine.client.eclipse.bpmn2.impl.OperationImpl#getOutMessageRef <em>Out Message Ref</em>}</li>
 *   <li>{@link org.submarine.client.eclipse.bpmn2.impl.OperationImpl#getErrorRefs <em>Error Refs</em>}</li>
 *   <li>{@link org.submarine.client.eclipse.bpmn2.impl.OperationImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.submarine.client.eclipse.bpmn2.impl.OperationImpl#getImplementationRef <em>Implementation Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationImpl extends BaseElementImpl implements Operation {
	 ...
	 */
	@GwtTransient
	protected EList<org.submarine.client.eclipse.bpmn2.Error> errorRefs;
	 ...
	 * @generated
	 */
	public List<org.submarine.client.eclipse.bpmn2.Error> getErrorRefs() {
		if (errorRefs == null) {
			errorRefs = new EObjectResolvingEList<org.submarine.client.eclipse.bpmn2.Error>(org.submarine.client.eclipse.bpmn2.Error.class, this,
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Bpmn2Package.OPERATION__ERROR_REFS:
			getErrorRefs().clear();
			getErrorRefs().addAll((Collection<? extends org.submarine.client.eclipse.bpmn2.Error>) newValue);
			return;
		case Bpmn2Package.OPERATION__NAME:
