...
public class XMISaveImpl extends XMLSaveImpl
{
  ...
  public Object writeTopObjects(List<? extends EObject> contents)
  {
    ...
    else
    {
      ...
      currentNode = document.createElement(/* fixme ns XMIResource.XMI_URI, */ XMI_TAG_NS);
  ...
  protected void saveTypeAttribute(EClass eClass)
  {
    if (xmiType)
    {
      ...
      {
        ((Element)currentNode).setAttribute(/* fixme ns XMIResource.XMI_URI, */ XMI_TYPE_NS, helper.getQName(eClass));
      }
    }
    else
    {
  ...
  public void addNamespaceDeclarations()
  {
    ...
    {
      ((Element)currentNode).setAttribute(/* fixme ns XMIResource.XMI_URI, */ XMI_VER_NS,  version);
      ((Element)currentNode).setAttribute(/* fixme ns ExtendedMetaData.XMLNS_URI, */ XMI_XMLNS, xmiURI);
    }
